...
public class UserAddressController : ApiController
{
    ...
    {
        var command = new EditUserAddressCommand(User.GetUserId(), viewModel.Province,viewModel.City, viewModel.PostalCode,
            viewModel.PostalAddress, new PhoneNumber(viewModel.PhoneNumber), viewModel.Name,
            viewModel.Family, viewModel.Id, viewModel.NationalCode);
